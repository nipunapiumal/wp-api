...
function izeetak_standard_fonts() {
	return array(
...
function izeetak_google_fonts_array() {
...
function izeetak_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = izeetak_google_fonts_array();
	...
	// Subset
	$subset = izeetak_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'izeetak-google-font-'. $handle, $url, false, false, 'all' );
}